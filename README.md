...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    Acessibility on the web is when the code for the page is written so a reader can understand what is on page.
...
3. How would you explain the concept of a variable to someone new to programming?
    ...
    a variable stores the data you want to use

4. What is the purpose of using functions in code?

    to give your website more functionality with cleaner code.
